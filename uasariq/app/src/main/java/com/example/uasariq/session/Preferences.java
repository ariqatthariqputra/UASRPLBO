package com.example.uasariq.session;
...
public class Preferences {
    ...
    public static void setIsnama(Context context, String tipe){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString("isnama", tipe);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_USER_TEREGISTER berupa String */
    public static String getIsnama(Context context){
        return getSharedPreference(context).getString("isnama","");
    }

    public static void setid_user(Context context, Integer tipe){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putInt("id_user", tipe);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_USER_TEREGISTER berupa String */
    public static Integer getid_user(Context context){
        return getSharedPreference(context).getInt("id_user",0);
    }
